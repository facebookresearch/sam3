...
# Changelog: - supports the "attn_type" flag
#            - remove support for causal
...
# Imported from pytorch
# Changelog: dropped support for the fast path
class MultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        assert sparsity == 0.0, "Sparsity not supported at the moment"
