...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='SAM3 Model Inference Script')
    parser.add_argument(
        '--input_img_path',
        type=str,
        default="/fsx-onevision/yuzhou1/datasets/refcoco/refer/data/images/mscoco/images/train2014/COCO_train2014_000000565220.jpg",
    ...
    parser.add_argument(
        ...
        type=str,
        default="top hot dog",
        help='Text prompt to ground (default: %(default)s)'
    )
    parser.add_argument(
        '--output_folder_path',
        type=str,
        default="/fsx-onevision/yuzhou1/code/sam_out",
        help='Path to save the processed image visualization (default: %(default)s)'
    )
    parser.add_argument(
        '--threshold',
        type=float,
        default=0.5,
        help='Threshold for mask prediction (default: %(default)s, range: [0.0, 1.0])'
    )
    ...
    call_sam_service(
        ...
        text_prompt=args.find_input_text,
